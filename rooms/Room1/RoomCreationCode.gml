...
// For each object type maintain a mask of where selection lines should stop
global.dcg_limit_obj_mask[0] = 0;
// For each object type maintain a max distance that selection lines are allowed to extend
...
global.dcg_action_selected = DC_ACTION_NONE;
